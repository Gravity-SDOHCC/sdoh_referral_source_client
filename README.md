...
- Sometimes when new links are added to the page (such as when a new referral is
  received), clicking on the link will have no effect until the page is reloaded
...
This project welcomes Pull Requests. Any issues identified with the RI should be submitted via the [GitHub issue tracker](https://github.com/Gravity-SDOHCC/sdoh_referral_source_client/issues).
